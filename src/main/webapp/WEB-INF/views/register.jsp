			...
			<div class="card-body p-0">
				...
				<div class="row">
					<div class="col-lg-5 d-none d-lg-block bg-register-image">
						<img src="./img/mart.png" width="380" height="610">
					</div>
					<div class="col-lg-7">
						<div class="p-5">
							...
							<form action="./register.do" method="POST" name="form1"
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<input type="password" class="form-control form-control-user"
											id="rpwd" name="rpwd" placeholder="Repeat Password">
									</div>
								</div>
	...
	<script>
		$(function() {
			...
			$("#btnIdCheck").click(function(e) {
				...
				if (email != "") {
					$.ajax({
						url : "./api/userEmailCheck.do?email=" + email,
						type : "GET",
						success : function(data) {
							console.log(data);
							if (data != "") {
								$(".with-errors").html("E-mail이 중복됩니다.");
								$("#idCheck").val(false);
							} else {
								$(".with-errors").html("사용가능한 E-mail 입니다.");
								$("#idCheck").val(true);
							}
						},
						error : function(e) {
		...
		function join() {
			...
			$(".with-errors").html("");
			if (check == "") {
				$(".with-errors").html("E-mail 중복체크 해주세요");
				return false;
			}
			if (check == "false") {
				$(".with-errors").html("E-mail이 중복됩니다.");
